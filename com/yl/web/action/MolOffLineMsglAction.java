...
public class MolOffLineMsglAction extends Action
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			throws Exception
	{
		System.out.println("===MolOffLineMsglAction back url=======");
		...
		// request.getParameter("TransDateTime")==null?"":request.getParameter("TransDateTime");
